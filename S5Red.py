...
def escribir_usuario(nombre,edad,estatura,estatura_m,estatura_cm,sexo,pais,num_amigos,estado):
        archivo_usuario= open(nombre + ".user", "w")
        archivo_usuario.write(nombre+ "/n")
        archivo_usuario.write(edad + "/n")
        archivo_usuario.write(estatura + "/n")
        archivo_usuario.write(estatura_m + "/n")
        archivo_usuario.write(estatura_cm + "/n")
        archivo_usuario.write(sexo + "/n")
        archivo_usuario.write(pais + "/n")
        archivo_usuario.write(num_amigos + "/n")
        archivo_usuario.write(estado + "/n")
        archivo_usuario.close()
